...
For Nodeport/ClusterIp service

```bash
 kubectl port-forward service/a-service 8088:80 --address=0.0.0.0 -n dev &
```

Go to browser Ec2-ip:port
```bash
http://35.174.138.147:8088/logs
```
