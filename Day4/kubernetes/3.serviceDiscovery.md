# 🌐 Kubernetes (K8s) Service Discovery Explained
...
## 💡 Definition of Service Discovery in K8s
...
## ⚙️ The Mechanism: Services and DNS

Kubernetes primarily implements service discovery through two core components: **Services** and the **internal DNS system**.
...
Would you like me to provide an example of how a Pod would use a DNS query to find another service?
